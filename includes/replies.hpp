...
#define RPL_CHANNELMODES(nickname, channelname, modes,key,limit) ": 324 " + nickname + " #" + channelname + " " + modes + " " + key + " " + limit + CRLF
...
#define ERR_ERRONEUSUSERNAME(username) (": 432 " + username + " :Erroneus username" + CRLF)
